...
- Identify the exam(s) or subject(s) implied by the goal as skill names (e.g. "GRE", "IELTS"), and break the weekly hours down across them. Assume Quant, IELTS, JS, Stats, and Deep Learning already exist as categories in the system; mark isNewCategory true for anything else. For a new category, propose 3-6 sub-skills it should be broken into (e.g. GRE -> Verbal Reasoning, Quantitative Reasoning, Analytical Writing, Vocabulary).
